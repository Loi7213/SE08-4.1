			...
			<div class="row inner-bottom-sm">
				<div class="shopping-cart">
												...
												<td colspan="7">
													<div class="shopping-cart-btn">
														<span class="">
															...
															<input type="submit" name="submit" value="Update quantity" class="btn btn-upper btn-primary outer-right-xs">
															<input type="submit" name="remove_code" value="Remove item" class="btn btn-upper btn-primary">
														</span>
					...
					<div class="col-md-4 col-sm-12 cart-shopping-total">
								...
								<tr>
									<th>
										<div class="cart-grand-total">
											<span class="inner-left-md">Grand Total</span>
										</div>
									</th>
								</tr>
								<tr>
									<th>
										<div class="cart-grand-total">
											<h3><?php echo "$ " . $_SESSION['tp'] = "$totalprice" . ".00"; ?></h3>
										</div>
									</th>
								</tr>
							</thead><!-- /thead -->
						...
						<div align='right'>
							<button type="submit" name="ordersubmit" class="btn btn-primary">PROCESS TO CHECKOUT</button>
						</div>
					<?php } else {
